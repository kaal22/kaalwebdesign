...
description: Creates standardized skills for the Antigravity agent environment following specific structural and formatting guidelines. Use when the user asks to create a new skill.
---
